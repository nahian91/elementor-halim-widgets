...
class Elementor_Services_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls(){
		...
		$this->add_control(
			'service_media_type',
			[
				'label' => __( 'Media Type', 'elementor-addon-halim' ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'options' => [
					'service_icon' => [
						'title' => __( 'Icon', 'elementor-addon-halim' ),
						'icon' => 'eicon-call-to-action',
					],
					'service_image' => [
						'title' => __( 'Image', 'elementor-addon-halim' ),
						'icon' => 'eicon-image-box',
					],
					'service_number' => [
						'title' => __( 'Number', 'elementor-addon-halim' ),
		...
		$this->add_control(
			'service_icon', [
				'label' => __( 'Icon', 'elementor-addon-halim' ),
		...
		$this->add_control(
			'service_image', [
				'label' => __( 'Image', 'elementor-addon-halim' ),
		...
		$this->add_control(
			'service_number', [
				'label' => __( 'Number', 'elementor-addon-halim' ),
		...
		$this->add_control(
			'service_title', [
				'label' => __( 'Title', 'elementor-addon-halim' ),
		...
		$this->add_control(
			'service_desc', [
				'label' => __( 'Description', 'elementor-addon-halim' ),
    ...
    protected function render() {
		...
		$service_media_type = $settings['service_media_type'];
	?>
		<div class="single-service">
				<?php
					if( 'service_image'){
						echo $service_media_type['service_image'];
					}
				?>
